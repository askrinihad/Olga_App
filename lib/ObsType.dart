...
class ObsType extends StatefulWidget {
  const ObsType({super.key});

  @override
  State<ObsType> createState() => _ObsTypeState();
}

class _ObsTypeState extends State<ObsType> {
  var currentPage  = DrawerSections.NouvelleObservation;
  @override
