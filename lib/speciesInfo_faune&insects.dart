        ...
        child: Padding(
          ...
          child: Column(
            ...
            SizedBox(height: 10),
               ...
               SizedBox(height: 10),
               Text(
                AppLocalizations.of(context)!.classe +" "+  AppLocalizations.of(context)!.de + " : ${widget.item["nom"]}",
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 18,
               ...
               SizedBox(height: 10),
               Text(
                AppLocalizations.of(context)!.ordre +" "+  AppLocalizations.of(context)!.de + " : ${widget.item["nom"]}",
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 18,
               ...
               SizedBox(height: 10),
               Text(
                AppLocalizations.of(context)!.regne +" "+  AppLocalizations.of(context)!.de + " : ${widget.item["nom"]}",
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 18,
              ...
              SizedBox(height: 10),
               Text(
                AppLocalizations.of(context)!.groupegrandpublic +" "+  AppLocalizations.of(context)!.de + " : ${widget.item["nom"]}",
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 18,
