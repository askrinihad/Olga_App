                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.of(context).push(
                                        ...
                                        if (snapshot.data!["faune"] == "" ||
                                            snapshot.data!["faune"] == null) {
                                          return NavBackbar(
                                              body: Center(
                                                  child: Text(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.of(context).push(
                                        ...
                                        if (snapshot.data!["flore"] == "" ||
                                            snapshot.data!["flore"] == null) {
                                          return NavBackbar(
                                              body: Center(
                                                  child: Text(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.of(context).push(
                                        ...
                                        if (snapshot.data!["insectes"] == "" ||
                                            snapshot.data!["insectes"] ==
                                                null) {
                                          return NavBackbar(
                                              body: Center(
                                                  child: Text(
