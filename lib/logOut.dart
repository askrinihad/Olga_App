...
class _logOutState extends State<logOut> {
  ...
  child: Column(
    children: [
      SizedBox(height: 200),
      Text(AppLocalizations.of(context)!.voulezDeconnecter, style: TextStyle(fontSize: 13)),
      SizedBox(height: 100),
      Row(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            child: Text(AppLocalizations.of(context)!.oui, style: TextStyle(color: Colors.white, fontSize: 13)),
          ),
        ],
      ),
    ],
