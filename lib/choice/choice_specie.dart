        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (context) => NouvelleObservation2(
                    ...
                    onPressed: () {
                      if (widget.argumentReceived == 'flore') {
                        ...
                        String combinedArgument =
                            "${widget.argumentReceived} protègé";
                        Navigator.of(context).pushReplacement(
                          MaterialPageRoute(
                            builder: (context) => ChoixPhoto(
                        ...
                        Navigator.of(context).pushReplacement(
                          MaterialPageRoute(
                            builder: (context) => ChoixPhoto_insectes(
                                argumentReceived: combinedArgument,
                                email: widget.email,
                                aeroport: widget.aeroport),
                          ),
                        ...
                        Navigator.of(context).pushReplacement(
                          MaterialPageRoute(
                            builder: (context) => ChoixPhoto_faune(
                                argumentReceived: combinedArgument,
                                email: widget.email,
                                aeroport: widget.aeroport),
                          ),
